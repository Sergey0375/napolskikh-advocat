  ...
  head: () => ({
    meta: [
      { title: `Кейсы адвоката — ${site.name}` },
      {
        name: "description",
        content:
          "Реальные дела: споры онлайн-школ с учениками, защита прав на курсы, взыскание долгов, раздел бизнеса при разводе, доследственные проверки.",
      },
      { property: "og:title", content: `Кейсы адвоката — ${site.name}` },
      {
        property: "og:description",
        content: "Результаты по делам инфобизнеса, арбитража, семейных и экономических споров.",
      },
